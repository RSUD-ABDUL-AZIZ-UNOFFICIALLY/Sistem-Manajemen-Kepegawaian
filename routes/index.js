...
router.get('/api/voters/participants', middleware.login, voters.index);
router.get('/api/voters/cek', middleware.login, voters.cek);
router.post('/api/voters/vote', middleware.login, voters.vote);
