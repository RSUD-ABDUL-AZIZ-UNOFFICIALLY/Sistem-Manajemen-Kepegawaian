...
function menuAkses() {
    ...
    let petugas = $('<li class="nav-item">  <a href="/simrs/home" class="nav-link"><i class="fa-solid fa-user-doctor nav-icon"></i><p>Petugas SIMRS</p></a></li>');
    ...
    t.includes("admin") && ($("#navbar").append(l),
        ...
        t.includes("petugas") && $("#ul_simrs").append(petugas),
