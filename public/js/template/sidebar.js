...
function menuAkses() {
    ...
    let att = $('<li class="nav-item"><a href="/presensi/attendence" class="nav-link"><i class="far fa-solid fa-calendar-check nav-icon"></i><p>Absen</p></a></li>');
    ...
    t.includes('adminAttendence') && $("#absen").append(att);
}
