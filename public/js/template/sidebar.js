...
function menuAkses() {
    ...
    let e = $('<ul class="nav nav-treeview"><li class="nav-item"><a href="/aprovecuti" class="nav-link"><i class="far fa-solid fa-bed nav-icon"></i><p>Persetujuan Cuti</p></a></li></ul>');
